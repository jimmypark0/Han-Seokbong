...
/*	Output test for 'get_stems()'.
		...
		*(term[i]-1) --- term type(defined in 'header/keyword.h')
		term[i]      --- term string
*/
void put_stems( FILE *fp, unsigned char *sent, unsigned char *term[], int n, HAM_RUNMODE *mode)
{
	int i;
...
//	if (open_HAM_index_dicpath(&mode, optstr, "./hdic/KLT2000.ini",
//		"/R/KLT210/EXE/hdic/", "ham-usr.dic", "ham-cnn.dic", "stopword.dic")) {
